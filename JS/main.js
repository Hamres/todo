...
function addTask(event) {
  ...
  //очищаем поле ввода и вернем фокус
  taskInput.value = ''
  taskInput.focus()
...
function deleteTask(event) {
  ...
  //определяем ID задачии
  const id = parenNode.id

  //назодим индекс задачи в массиве
...
function checkEmptyList() {
  if (tasks.length === 0) {
    const emptyListHTML = `
      ...
      <img src="/img/task.png" alt="Empty" width="48" class="mt-3" />
